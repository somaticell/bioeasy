...
public class c extends d implements ServiceConnection {
    private String d;
    private String e;
    private String[] f;
    ...
    public void onServiceConnected(ComponentName name, IBinder service) {
        try {
            ...
            Object invoke = method.invoke((Object) null, new Object[]{service});
    ...
    private boolean a(String str, String str2) {
        ...
        if (this.f != null && this.f.length > 0) {
            intent.putExtra("scope", TextUtils.join(ListUtils.DEFAULT_JOIN_SEPARATOR, this.f));
        }
        if (!b(intent)) {
            return false;
        }
    ...
    private boolean b(Intent intent) {
        ...
        try {
            for (Signature charsString : this.a.getContext().getPackageManager().getPackageInfo(resolveActivity.activityInfo.packageName, 64).signatures) {
