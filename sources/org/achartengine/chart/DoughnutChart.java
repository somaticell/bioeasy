...
public class DoughnutChart extends RoundChart {
    ...
    public void draw(Canvas canvas, int x, int y, int width, int height, Paint paint) {
        ...
        for (int category2 = 0; category2 < cLength; category2++) {
            ...
            paint.setStyle(Paint.Style.FILL);
            canvas.drawArc(new RectF((float) (this.mCenterX - radius2), (float) (this.mCenterY - radius2), (float) (this.mCenterX + radius2), (float) (this.mCenterY + radius2)), 0.0f, 360.0f, true, paint);
            radius = radius2 - 1;
        }
