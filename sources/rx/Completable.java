...
public class Completable {
                ...
                try {
                    ...
                    try {
                        ...
                        if (cs == null) {
                            ...
                            final AtomicBoolean once = new AtomicBoolean();
                            cs.subscribe((CompletableSubscriber) new CompletableSubscriber() {
                                Subscription d;
    ...
    public final void await() {
        ...
        subscribe((CompletableSubscriber) new CompletableSubscriber() {
            public void onCompleted() {
                cdl.countDown();
            }
    ...
    public final <T> Observable<T> andThen(Observable<T> next) {
        requireNonNull(next);
        return next.delaySubscription((Observable<U>) toObservable());
    }
    ...
    public final Completable delay(long delay, TimeUnit unit, Scheduler scheduler, boolean delayError) {
        ...
        return create(new CompletableOnSubscribe() {
            public void call(final CompletableSubscriber s) {
                ...
                set.add(w);
                Completable.this.subscribe((CompletableSubscriber) new CompletableSubscriber() {
                    public void onCompleted() {
    ...
    public final <T> Observable<T> endWith(Observable<T> next) {
        return next.startWith((Observable<T>) toObservable());
    }
                ...
                Completable.this.subscribe((CompletableSubscriber) new CompletableSubscriber() {
                    ...
                    public void onError(Throwable e) {
                        try {
                            ...
                            new CompositeException((Collection<? extends Throwable>) Arrays.asList(new Throwable[]{e, ex}));
                        }
                    }
                ...
                Completable.this.subscribe((CompletableSubscriber) new CompletableSubscriber() {
                    ...
                    public void onError(Throwable e) {
                        try {
                            ...
                            if (c == null) {
                                CompositeException compositeException = new CompositeException((Collection<? extends Throwable>) Arrays.asList(new Throwable[]{e, new NullPointerException("The completable returned is null")}));
                                s.onError(compositeException);
                                CompositeException compositeException2 = compositeException;
                                return;
                            }
                            c.subscribe((CompletableSubscriber) new CompletableSubscriber() {
                                public void onCompleted() {
                                    s.onCompleted();
                                }
                            ...
                            CompositeException compositeException3 = new CompositeException((Collection<? extends Throwable>) Arrays.asList(new Throwable[]{e, ex}));
                            s.onError(compositeException3);
                            CompositeException compositeException4 = compositeException3;
                        }
                    }
    ...
    public final Completable timeout(long timeout, TimeUnit unit) {
        return timeout0(timeout, unit, Schedulers.computation(), (Completable) null);
    }
    ...
    public final Completable timeout(long timeout, TimeUnit unit, Scheduler scheduler) {
        return timeout0(timeout, unit, scheduler, (Completable) null);
    }
