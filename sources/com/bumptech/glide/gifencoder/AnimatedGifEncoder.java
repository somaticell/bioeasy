...
public class AnimatedGifEncoder {
    ...
    private void analyzePixels() {
        ...
        while (i2 < nPix) {
            int k2 = k + 1;
            int k3 = k2 + 1;
            int index = nq.map(this.pixels[k] & BLEServiceApi.CONNECTED_STATUS, this.pixels[k2] & BLEServiceApi.CONNECTED_STATUS, this.pixels[k3] & BLEServiceApi.CONNECTED_STATUS);
    ...
    private int findClosest(int color) {
        ...
        while (i < len) {
            int i2 = i + 1;
            int dr = r - (this.colorTab[i] & BLEServiceApi.CONNECTED_STATUS);
            int i3 = i2 + 1;
            int dg = g - (this.colorTab[i2] & BLEServiceApi.CONNECTED_STATUS);
            int db = b - (this.colorTab[i3] & BLEServiceApi.CONNECTED_STATUS);
