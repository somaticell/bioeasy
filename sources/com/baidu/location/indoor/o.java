    ...
    private void j() {
        ...
        try {
            ...
            for (Sensor type : sensorList) {
                ...
                if (hashMap.get(Integer.valueOf(type2)) != null && (intValue = ((Integer) hashMap.get(Integer.valueOf(type2))).intValue()) < size) {
                    cArr[intValue] = '1';
                }
            }
    ...
    public void a() {
        if (!this.e) {
            if (this.g != null) {
                ...
                this.a.schedule(new q(this), 500, 30);
                this.e = true;
            }
            if (this.h != null) {
                try {
