...
public class MobViewPager extends ViewGroup {
    ...
    public void setAdapter(ViewPagerAdapter adapter2) {
        if (this.adapter != null) {
            this.adapter.setMobViewPager((MobViewPager) null);
        }
        ...
        this.screenCount = adapter2.getCount();
        if (this.screenCount <= 0) {
            ...
            if (this.currentScreen > 0) {
                this.previousPage = adapter2.getView(this.currentScreen - 1, this.previousPage, this);
                addView(this.previousPage);
            }
            this.currentPage = adapter2.getView(this.currentScreen, this.currentPage, this);
            addView(this.currentPage);
            if (this.currentScreen < this.screenCount - 1) {
                this.nextPage = adapter2.getView(this.currentScreen + 1, this.nextPage, this);
    ...
    public void computeScroll() {
        if (this.adapter != null && this.screenCount > 0) {
            ...
            if (this.adapter != null) {
                float total = (float) (this.scroller.getFinalX() - this.scroller.getStartX());
                this.adapter.onScreenChanging(((float) (this.scroller.getCurrX() - this.scroller.getStartX())) / total);
            }
        }
    }
