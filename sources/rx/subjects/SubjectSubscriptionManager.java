...
final class SubjectSubscriptionManager<T> extends AtomicReference<State<T>> implements Observable.OnSubscribe<T> {
    ...
    public void remove(rx.subjects.SubjectSubscriptionManager.SubjectObserver<T> r4) {
        ...
        L_0x000a:
            return
        L_0x000b:
            rx.subjects.SubjectSubscriptionManager$State r0 = r1.remove(r4)
    ...
    protected static final class SubjectObserver<T> implements Observer<T> {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:14:0x0017, code lost:
            emitLoop((java.util.List<java.lang.Object>) null, r3, r4);
         */
         ...
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public void emitFirst(java.lang.Object r3, rx.internal.operators.NotificationLite<T> r4) {
            /*
                r2 = this;
                r0 = 0
                monitor-enter(r2)
         ...
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public void emitLoop(java.util.List<java.lang.Object> r7, java.lang.Object r8, rx.internal.operators.NotificationLite<T> r9) {
            /*
                r6 = this;
                r2 = 1
                r3 = 0
