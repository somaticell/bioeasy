        ...
        while (i5 < length) {
            ...
            if (optJSONObject == null) {
                ...
                if (optString2 == null) {
                    ...
                    optString2 = distance < 1000 ? " - " + distance + "米" : " - " + (((double) distance) / 1000.0d) + "公里";
        ...
        try {
            ...
            switch (optJSONObject.optInt("error")) {
                case 0:
                    ...
                    JSONObject optJSONObject4 = optJSONObject2.optJSONObject(UriUtil.LOCAL_CONTENT_SCHEME);
                    if (optJSONObject3 == null || optJSONObject4 == null) {
                        return false;
                    }
                    RouteNode a = a(optJSONObject3.optJSONObject("start"));
                    ArrayList arrayList = new ArrayList();
                    RouteNode a2 = a(optJSONObject3.optJSONArray("end"), (List<RouteNode>) arrayList);
