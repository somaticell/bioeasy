...
public final class OperatorMulticast<T, R> extends ConnectableObservable<R> {
    ...
    public void connect(rx.functions.Action1<? super rx.Subscription> r8) {
        /*
            ...
            monitor-enter(r6)
            rx.Subscriber<T> r5 = r7.subscription     // Catch:{ all -> 0x0050 }
            if (r5 == 0) goto L_0x000e
            rx.Subscription r5 = r7.guardedSubscription     // Catch:{ all -> 0x0050 }
            r8.call(r5)     // Catch:{ all -> 0x0050 }
            monitor-exit(r6)     // Catch:{ all -> 0x0050 }
        L_0x000d:
            return
        L_0x000e:
            rx.functions.Func0<? extends rx.subjects.Subject<? super T, ? extends R>> r5 = r7.subjectFactory     // Catch:{ all -> 0x0050 }
            java.lang.Object r4 = r5.call()     // Catch:{ all -> 0x0050 }
            rx.subjects.Subject r4 = (rx.subjects.Subject) r4     // Catch:{ all -> 0x0050 }
            rx.Subscriber r5 = rx.observers.Subscribers.from(r4)     // Catch:{ all -> 0x0050 }
            ...
            rx.internal.operators.OperatorMulticast$2 r5 = new rx.internal.operators.OperatorMulticast$2     // Catch:{ all -> 0x0050 }
            r5.<init>(r0)     // Catch:{ all -> 0x0050 }
            rx.Subscription r5 = rx.subscriptions.Subscriptions.create(r5)     // Catch:{ all -> 0x0050 }
            r0.set(r5)     // Catch:{ all -> 0x0050 }
            java.lang.Object r5 = r0.get()     // Catch:{ all -> 0x0050 }
            rx.Subscription r5 = (rx.Subscription) r5     // Catch:{ all -> 0x0050 }
            r7.guardedSubscription = r5     // Catch:{ all -> 0x0050 }
            java.util.List<rx.Subscriber<? super R>> r5 = r7.waitingForConnect     // Catch:{ all -> 0x0050 }
        ...
        L_0x003b:
            ...
            rx.Subscriber r2 = (rx.Subscriber) r2     // Catch:{ all -> 0x0050 }
            rx.internal.operators.OperatorMulticast$3 r5 = new rx.internal.operators.OperatorMulticast$3     // Catch:{ all -> 0x0050 }
        ...
        L_0x0053:
            ...
            java.util.concurrent.atomic.AtomicReference<rx.subjects.Subject<? super T, ? extends R>> r5 = r7.connectedSubject     // Catch:{ all -> 0x0050 }
            r5.set(r4)     // Catch:{ all -> 0x0050 }
            monitor-exit(r6)     // Catch:{ all -> 0x0050 }
            rx.Subscription r5 = r7.guardedSubscription
            r8.call(r5)
            java.lang.Object r6 = r7.guard
            monitor-enter(r6)
            rx.Subscriber<T> r3 = r7.subscription     // Catch:{ all -> 0x0071 }
            monitor-exit(r6)     // Catch:{ all -> 0x0071 }
            if (r3 == 0) goto L_0x000d
            rx.Observable<? extends T> r5 = r7.source
            r5.subscribe(r3)
            goto L_0x000d
        L_0x0071:
            r5 = move-exception
