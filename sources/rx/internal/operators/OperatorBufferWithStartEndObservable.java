    ...
    final class BufferingSubscriber extends Subscriber<T> {
        ...
        public void onCompleted() {
            ...
            L_0x001b:
                ...
                rx.Subscriber<? super java.util.List<T>> r4 = r5.child     // Catch:{ Throwable -> 0x002d }
                r4.onNext(r0)     // Catch:{ Throwable -> 0x002d }
                goto L_0x001b
            L_0x002d:
                r2 = move-exception
                rx.Subscriber<? super java.util.List<T>> r4 = r5.child
                rx.exceptions.Exceptions.throwOrReport((java.lang.Throwable) r2, (rx.Observer<?>) r4)
                goto L_0x0006
            L_0x0034:
                r4 = move-exception
                monitor-exit(r5)     // Catch:{ all -> 0x0034 }
        ...
        public void startBuffer(TOpening r6) {
            ...
            L_0x000c:
                ...
                monitor-exit(r5)     // Catch:{ all -> 0x002a }
                rx.internal.operators.OperatorBufferWithStartEndObservable r4 = rx.internal.operators.OperatorBufferWithStartEndObservable.this     // Catch:{ Throwable -> 0x002d }
                rx.functions.Func1<? super TOpening, ? extends rx.Observable<? extends TClosing>> r4 = r4.bufferClosing     // Catch:{ Throwable -> 0x002d }
                java.lang.Object r2 = r4.call(r6)     // Catch:{ Throwable -> 0x002d }
                rx.Observable r2 = (rx.Observable) r2     // Catch:{ Throwable -> 0x002d }
                rx.internal.operators.OperatorBufferWithStartEndObservable$BufferingSubscriber$1 r1 = new rx.internal.operators.OperatorBufferWithStartEndObservable$BufferingSubscriber$1
                r1.<init>(r0)
                rx.subscriptions.CompositeSubscription r4 = r5.closingSubscriptions
                r4.add(r1)
            ...
            L_0x002d:
                r3 = move-exception
                rx.exceptions.Exceptions.throwOrReport((java.lang.Throwable) r3, (rx.Observer<?>) r5)
                goto L_0x000b
            */
            throw new UnsupportedOperationException("Method not decompiled: rx.internal.operators.OperatorBufferWithStartEndObservable.BufferingSubscriber.startBuffer(java.lang.Object):void");
        }
