...
public class MobRSA {
    ...
    private byte[] recoveryPaddingBlock(byte[] padding) throws Throwable {
        ...
        int len = ((padding[1] & BLEServiceApi.CONNECTED_STATUS) << 24) + ((padding[2] & BLEServiceApi.CONNECTED_STATUS) << 16) + ((padding[3] & BLEServiceApi.CONNECTED_STATUS) << 8) + (padding[4] & BLEServiceApi.CONNECTED_STATUS);
