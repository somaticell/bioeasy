...
public class c {
    ...
    private long a(int r8) {
        /*
            r7 = this;
            r0 = -1
            java.lang.String r2 = com.baidu.location.f.j.h()
        ...
        L_0x0062:
            ...
            goto L_0x004c
        */
        throw new UnsupportedOperationException("Method not decompiled: com.baidu.location.f.c.a(int):long");
    }
    ...
    private void a(int i2, long j) {
        ...
        if (h2 != null) {
            try {
                RandomAccessFile randomAccessFile = new RandomAccessFile(h2 + File.separator + this.a, "rw");
