        ...
        private ParameterHandler<?> parseParameterAnnotation(int p, Type type, Annotation[] annotations, Annotation annotation) {
            if (annotation instanceof Url) {
                if (this.gotUrl) {
                    ...
                    throw parameterError(p, "@Url must be String, java.net.URI, or android.net.Uri type.", new Object[0]);
                }
                ...
                if (Iterable.class.isAssignableFrom(rawParameterType3)) {
                    ...
                    return new ParameterHandler.Header(name3, this.retrofit.stringConverter(ServiceMethod.boxIfPrimitive(rawParameterType3.getComponentType()), annotations)).array();
                }
                ...
                if (Iterable.class.isAssignableFrom(rawParameterType4)) {
                    ...
                    return new ParameterHandler.Field(name4, this.retrofit.stringConverter(Utils.getParameterUpperBound(0, (ParameterizedType) type), annotations), encoded2).iterable();
                } else if (!rawParameterType4.isArray()) {
                    return new ParameterHandler.Field(name4, this.retrofit.stringConverter(type, annotations), encoded2);
                } else {
                    return new ParameterHandler.Field(name4, this.retrofit.stringConverter(ServiceMethod.boxIfPrimitive(rawParameterType4.getComponentType()), annotations), encoded2).array();
                }
                ...
                if (String.class != keyType2) {
                    throw parameterError(p, "@FieldMap keys must be of type String: " + keyType2, new Object[0]);
                }
                Converter<?, String> valueConverter = this.retrofit.stringConverter(Utils.getParameterUpperBound(1, parameterizedType2), annotations);
                this.gotField = true;
                ...
                if (!partName.isEmpty()) {
                    ...
                    if (Iterable.class.isAssignableFrom(rawParameterType6)) {
                        ...
                        Class<?> arrayComponentType = ServiceMethod.boxIfPrimitive(rawParameterType6.getComponentType());
                    ...
                    } else if (MultipartBody.Part.class.isAssignableFrom(rawParameterType6)) {
                ...
                if (String.class != keyType3) {
                    throw parameterError(p, "@PartMap keys must be of type String: " + keyType3, new Object[0]);
                }
                Type valueType = Utils.getParameterUpperBound(1, parameterizedType3);
