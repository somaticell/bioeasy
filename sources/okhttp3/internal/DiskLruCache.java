...
public final class DiskLruCache implements Closeable, Flushable {
            ...
            synchronized (DiskLruCache.this) {
                ...
                if (!z && !DiskLruCache.this.closed) {
                    try {
                        ...
                        boolean unused = DiskLruCache.this.mostRecentTrimFailed = true;
                    }
                    if (DiskLruCache.this.journalRebuildRequired()) {
                        DiskLruCache.this.rebuildJournal();
                        int unused2 = DiskLruCache.this.redundantOpCount = 0;
                    }
                }
            }
        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x002b, code lost:
        if (okhttp3.internal.DiskLruCache.Entry.access$1000(r1) == null) goto L_0x002d;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public synchronized okhttp3.internal.DiskLruCache.Editor edit(java.lang.String r5, long r6) throws java.io.IOException {
        /*
            r4 = this;
            r0 = 0
            monitor-enter(r4)
            ...
            java.util.LinkedHashMap<java.lang.String, okhttp3.internal.DiskLruCache$Entry> r2 = r4.lruEntries     // Catch:{ all -> 0x0039 }
            java.lang.Object r1 = r2.get(r5)     // Catch:{ all -> 0x0039 }
            okhttp3.internal.DiskLruCache$Entry r1 = (okhttp3.internal.DiskLruCache.Entry) r1     // Catch:{ all -> 0x0039 }
            r2 = -1
        ...
        L_0x0025:
            ...
            okhttp3.internal.DiskLruCache$Editor r2 = r1.currentEditor     // Catch:{ all -> 0x0039 }
        ...
        L_0x003c:
            ...
            okhttp3.internal.DiskLruCache$Entry r1 = new okhttp3.internal.DiskLruCache$Entry     // Catch:{ all -> 0x0039 }
            r2 = 0
            r1.<init>(r5)     // Catch:{ all -> 0x0039 }
            java.util.LinkedHashMap<java.lang.String, okhttp3.internal.DiskLruCache$Entry> r2 = r4.lruEntries     // Catch:{ all -> 0x0039 }
            r2.put(r5, r1)     // Catch:{ all -> 0x0039 }
        L_0x0069:
            okhttp3.internal.DiskLruCache$Editor r0 = new okhttp3.internal.DiskLruCache$Editor     // Catch:{ all -> 0x0039 }
            r2 = 0
            r0.<init>(r1)     // Catch:{ all -> 0x0039 }
            okhttp3.internal.DiskLruCache.Editor unused = r1.currentEditor = r0     // Catch:{ all -> 0x0039 }
            goto L_0x0023
        */
    ...
    public final class Editor {
        ...
        public Sink newSink(int index) throws IOException {
            ...
            synchronized (DiskLruCache.this) {
                ...
                try {
                    access$2600 = new FaultHidingSink(DiskLruCache.this.fileSystem.sink(this.entry.dirtyFiles[index])) {
                        /* access modifiers changed from: protected */
                        public void onException(IOException e) {
                            synchronized (DiskLruCache.this) {
                    ...
                    access$2600 = DiskLruCache.NULL_SINK;
                }
            }
            return access$2600;
        }
