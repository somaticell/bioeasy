...
public class SerializedObserver<T> implements Observer<T> {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:38:0x0046, code lost:
        r10.terminated = true;
        rx.exceptions.Exceptions.throwOrReport(r1, r10.actual, r11);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:53:0x006e, code lost:
        ...
        r10.actual.onError(rx.exceptions.OnErrorThrowable.addValueAsLastCause(r1, r11));
     */
    ...
    public void onNext(T r11) {
        ...
        L_0x0010:
            ...
            rx.observers.SerializedObserver$FastList r5 = r10.queue     // Catch:{ all -> 0x000d }
            if (r5 != 0) goto L_0x001f
            rx.observers.SerializedObserver$FastList r5 = new rx.observers.SerializedObserver$FastList     // Catch:{ all -> 0x000d }
            r5.<init>()     // Catch:{ all -> 0x000d }
            r10.queue = r5     // Catch:{ all -> 0x000d }
        L_0x001f:
            rx.internal.operators.NotificationLite<T> r7 = r10.nl     // Catch:{ all -> 0x000d }
        ...
        L_0x002a:
            ...
            monitor-exit(r10)     // Catch:{ all -> 0x000d }
            rx.Observer<? super T> r7 = r10.actual     // Catch:{ Throwable -> 0x0045 }
        ...
        L_0x0034:
            ...
            monitor-enter(r10)
            rx.observers.SerializedObserver$FastList r5 = r10.queue     // Catch:{ all -> 0x0042 }
        ...
        L_0x005c:
            ...
            goto L_0x0034
        L_0x005f:
            rx.internal.operators.NotificationLite<T> r7 = r10.nl     // Catch:{ Throwable -> 0x006d }
            rx.Observer<? super T> r8 = r10.actual     // Catch:{ Throwable -> 0x006d }
