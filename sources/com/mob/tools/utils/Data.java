...
public class Data {
    ...
    public static String MD5(File data) {
        ...
        try {
            FileInputStream fis = new FileInputStream(data);
            byte[] md5 = rawMD5((InputStream) fis);
            fis.close();
            if (md5 != null) {
                return toHex(md5);
            }
    ...
    public static byte[] rawMD5(byte[] data) {
        ...
        try {
            ...
            byte[] md5 = rawMD5((InputStream) bais);
            bais.close();
            return md5;
        } catch (Throwable e) {
            MobLog.getInstance().w(e);
    ...
    public static String CRC32(byte[] data) throws Throwable {
        ...
        sb.append(String.format("%02x", new Object[]{Integer.valueOf(((byte) ((int) (value >>> 56))) & BLEServiceApi.CONNECTED_STATUS)}));
        sb.append(String.format("%02x", new Object[]{Integer.valueOf(((byte) ((int) (value >>> 48))) & BLEServiceApi.CONNECTED_STATUS)}));
        sb.append(String.format("%02x", new Object[]{Integer.valueOf(((byte) ((int) (value >>> 40))) & BLEServiceApi.CONNECTED_STATUS)}));
        sb.append(String.format("%02x", new Object[]{Integer.valueOf(((byte) ((int) (value >>> 32))) & BLEServiceApi.CONNECTED_STATUS)}));
        sb.append(String.format("%02x", new Object[]{Integer.valueOf(((byte) ((int) (value >>> 24))) & BLEServiceApi.CONNECTED_STATUS)}));
        sb.append(String.format("%02x", new Object[]{Integer.valueOf(((byte) ((int) (value >>> 16))) & BLEServiceApi.CONNECTED_STATUS)}));
        sb.append(String.format("%02x", new Object[]{Integer.valueOf(((byte) ((int) (value >>> 8))) & BLEServiceApi.CONNECTED_STATUS)}));
        sb.append(String.format("%02x", new Object[]{Integer.valueOf(((byte) ((int) value)) & BLEServiceApi.CONNECTED_STATUS)}));
        while (sb.charAt(0) == '0') {
