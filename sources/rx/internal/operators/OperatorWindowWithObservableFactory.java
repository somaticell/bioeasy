...
public final class OperatorWindowWithObservableFactory<T, U> implements Observable.Operator<Observable<T>, T> {
    ...
    static final class SourceSubscriber<T, U> extends Subscriber<T> {
        ...
        public void onNext(T r7) {
            ...
            L_0x004c:
                monitor-exit(r4)     // Catch:{ all -> 0x0062 }
                rx.Subscriber<? super rx.Observable<T>> r3 = r6.child     // Catch:{ all -> 0x0065 }
        ...
        public void onCompleted() {
            ...
            L_0x0012:
                java.util.List<java.lang.Object> r2 = r5.queue     // Catch:{ all -> 0x002f }
                rx.internal.operators.NotificationLite<java.lang.Object> r4 = rx.internal.operators.OperatorWindowWithObservableFactory.nl     // Catch:{ all -> 0x002f }
            ...
            L_0x0032:
                ...
                goto L_0x001e
            */
            throw new UnsupportedOperationException("Method not decompiled: rx.internal.operators.OperatorWindowWithObservableFactory.SourceSubscriber.onCompleted():void");
        }
        ...
        public void replaceWindow() {
            ...
            L_0x0012:
                java.util.List<java.lang.Object> r3 = r6.queue     // Catch:{ all -> 0x004b }
                java.lang.Object r5 = rx.internal.operators.OperatorWindowWithObservableFactory.NEXT_SUBJECT     // Catch:{ all -> 0x004b }
            ...
            L_0x004e:
                monitor-exit(r4)     // Catch:{ all -> 0x0064 }
                rx.Subscriber<? super rx.Observable<T>> r3 = r6.child     // Catch:{ all -> 0x0067 }
    ...
    static final class BoundarySubscriber<T, U> extends Subscriber<U> {
        ...
        public BoundarySubscriber(Subscriber<?> subscriber, SourceSubscriber<T, U> sub2) {
            this.sub = sub2;
        }
