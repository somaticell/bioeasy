...
public class h extends e {
    ...
    private void a(PoiBoundSearchOption poiBoundSearchOption) {
        ...
        this.a.a("ar", "(" + ll2point.x + ListUtils.DEFAULT_JOIN_SEPARATOR + ll2point.y + com.alipay.sdk.util.h.b + ll2point2.x + ListUtils.DEFAULT_JOIN_SEPARATOR + ll2point2.y + ")");
        this.a.a("l", "12");
        this.a.a("b", "(" + ll2point.x + ListUtils.DEFAULT_JOIN_SEPARATOR + ll2point.y + com.alipay.sdk.util.h.b + ll2point2.x + ListUtils.DEFAULT_JOIN_SEPARATOR + ll2point2.y + ")");
    }
    ...
    private void a(PoiNearbySearchOption poiNearbySearchOption) {
        ...
        this.a.a("ar", "(" + point.x + ListUtils.DEFAULT_JOIN_SEPARATOR + point.y + com.alipay.sdk.util.h.b + point2.x + ListUtils.DEFAULT_JOIN_SEPARATOR + point2.y + ")");
        this.a.a("l", "12");
        this.a.a("b", "(" + point.x + ListUtils.DEFAULT_JOIN_SEPARATOR + point.y + com.alipay.sdk.util.h.b + point2.x + ListUtils.DEFAULT_JOIN_SEPARATOR + point2.y + ")");
        this.a.a("distance", poiNearbySearchOption.mRadius + "");
        this.a.a("center_rank", a.e);
        this.a.a("loc", "(" + ll2point.x + ListUtils.DEFAULT_JOIN_SEPARATOR + ll2point.y + ")");
    }
