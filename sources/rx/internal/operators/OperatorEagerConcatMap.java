...
public final class OperatorEagerConcatMap<T, R> implements Observable.Operator<R, T> {
    ...
    static final class EagerOuterSubscriber<T, R> extends Subscriber<T> {
        ...
        public EagerOuterSubscriber(Func1<? super T, ? extends Observable<? extends R>> mapper2, int bufferSize2, int maxConcurrent, Subscriber<? super R> actual2) {
            ...
            this.bufferSize = bufferSize2;
            this.actual = actual2;
            request(maxConcurrent == Integer.MAX_VALUE ? Clock.MAX_TIME : (long) maxConcurrent);
        }
        ...
        public void onNext(T r6) {
            /*
                r5 = this;
                rx.functions.Func1<? super T, ? extends rx.Observable<? extends R>> r3 = r5.mapper     // Catch:{ Throwable -> 0x0014 }
                java.lang.Object r2 = r3.call(r6)     // Catch:{ Throwable -> 0x0014 }
                rx.Observable r2 = (rx.Observable) r2     // Catch:{ Throwable -> 0x0014 }
            ...
            L_0x0014:
                r0 = move-exception
                rx.Subscriber<? super R> r3 = r5.actual
                rx.exceptions.Exceptions.throwOrReport(r0, r3, r6)
                goto L_0x0013
            L_0x001b:
                java.util.LinkedList<rx.internal.operators.OperatorEagerConcatMap$EagerInnerSubscriber<R>> r4 = r5.subscribers
                monitor-enter(r4)
            ...
            L_0x0024:
                ...
                throw r3
            L_0x0027:
                java.util.LinkedList<rx.internal.operators.OperatorEagerConcatMap$EagerInnerSubscriber<R>> r3 = r5.subscribers     // Catch:{ all -> 0x0024 }
