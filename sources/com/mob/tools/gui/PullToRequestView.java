...
public class PullToRequestView extends RelativeLayout {
    ...
    public void setAdapter(PullToRequestAdatper adapter2) {
        this.adapter = adapter2;
        removeAllViews();
        this.bodyView = (View) adapter2.getBodyView();
        RelativeLayout.LayoutParams lpBody = new RelativeLayout.LayoutParams(-1, -1);
        lpBody.addRule(9);
        lpBody.addRule(11);
        lpBody.addRule(10);
        addView(this.bodyView, lpBody);
        this.headerView = adapter2.getHeaderView();
        ...
        this.footerView = adapter2.getFooterView();
