...
public final class OperatorSwitch<T> implements Observable.Operator<T, Observable<? extends T>> {
    ...
    private static final class SwitchSubscriber<T> extends Subscriber<Observable<? extends T>> {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:35:0x008d, code lost:
            if (r22 == com.facebook.common.time.Clock.MAX_TIME) goto L_0x0097;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:50:0x00c7, code lost:
            if (r19.get() != rx.internal.operators.OperatorSwitch.InnerSubscriber.access$000((rx.internal.operators.OperatorSwitch.InnerSubscriber) r8.poll())) goto L_0x0048;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:57:0x00e9, code lost:
            if (r7 == TERMINAL_ERROR) goto L_0x00f7;
         */
        ...
        public void drain() {
            ...
            L_0x00ab:
                ...
                rx.internal.operators.OperatorSwitch$InnerSubscriber r18 = (rx.internal.operators.OperatorSwitch.InnerSubscriber) r18
                r0 = r25
                rx.internal.operators.NotificationLite<T> r4 = r0.nl
