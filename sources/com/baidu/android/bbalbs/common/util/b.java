...
public final class b {
    ...
    private static String a(byte[] bArr) {
        ...
        String str = "";
        for (byte b2 : bArr) {
            String hexString = Integer.toHexString(b2 & BLEServiceApi.CONNECTED_STATUS);
                    ...
                    try {
                        ...
                        if (bundle != null) {
                            ...
                            if (!TextUtils.isEmpty(string)) {
                                ...
                                if (this.b.getPackageName().equals(next.activityInfo.applicationInfo.packageName)) {
                                    aVar.d = true;
                                }
                                if (z) {
    ...
    private void a() {
        /*
            ...
            byte[] r2 = com.baidu.android.bbalbs.common.util.a.a()     // Catch:{ Exception -> 0x0025, all -> 0x0032 }
    ...
    private boolean a(java.lang.String r7) {
        ...
        L_0x0021:
            ...
            boolean r2 = com.baidu.android.bbalbs.common.util.b.c.a(r1, r0)
        L_0x003a:
            return r2
        L_0x003b:
            r0 = r2
        ...
        L_0x0042:
            ...
            r2 = r3
        L_0x0044:
            b((java.lang.Throwable) r0)     // Catch:{ all -> 0x005f }
    ...
    private C0003b b() {
        ...
        C0003b a3 = file.exists() ? C0003b.a(f(a(file))) : null;
        if (a3 == null) {
            this.c |= 16;
        ...
        bVar = a3;
        if (bVar == null) {
            bVar = C0003b.a(f(b("com.baidu.deviceid.v2")));
        }
        ...
        if (bVar2 == null) {
            ...
            C0003b bVar4 = new C0003b((c) null);
            String b2 = b(this.b);
            bVar4.a = com.baidu.android.bbalbs.common.a.c.a((Build.VERSION.SDK_INT < 23 ? str + b2 + UUID.randomUUID().toString() : "com.baidu" + b2).getBytes(), true);
            bVar4.b = str;
            bVar3 = bVar4;
        } else {
            bVar3 = bVar2;
        ...
        if ((this.c & 16) != 0 || !file3.exists()) {
            String e2 = TextUtils.isEmpty((CharSequence) null) ? e(bVar3.a()) : null;
            a(e2);
            str3 = e2;
        }
        boolean c3 = c();
    ...
    private static C0003b c(Context context) {
        if (e == null) {
    ...
    private C0003b d() {
        ...
        if (TextUtils.isEmpty(b2)) {
            b2 = b(com.baidu.android.bbalbs.common.a.c.a(("com.baidu" + b3 + b(this.b)).getBytes(), true));
        }
        if (TextUtils.isEmpty(b2)) {
            return null;
        }
        C0003b bVar = new C0003b((c) null);
        bVar.a = b2;
        bVar.b = b3;
        return bVar;
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private com.baidu.android.bbalbs.common.util.b.C0003b d(java.lang.String r9) {
        /*
            r8 = this;
            r2 = 0
            r3 = 0
        ...
        L_0x0049:
            ...
            com.baidu.android.bbalbs.common.util.b$b r3 = new com.baidu.android.bbalbs.common.util.b$b
            r3.<init>(r2)
            r3.a = r0
            r3.b = r1
            r0 = r3
        ...
        L_0x0067:
            ...
            byte[] r4 = com.baidu.android.bbalbs.common.a.b.a(r4)     // Catch:{ FileNotFoundException -> 0x0047, IOException -> 0x00be, Exception -> 0x00b9 }
            byte[] r4 = com.baidu.android.bbalbs.common.a.a.b(r6, r7, r4)     // Catch:{ FileNotFoundException -> 0x0047, IOException -> 0x00be, Exception -> 0x00b9 }
            r1.<init>(r4)     // Catch:{ FileNotFoundException -> 0x0047, IOException -> 0x00be, Exception -> 0x00b9 }
            java.lang.String r4 = "="
    ...
    private C0003b e() {
        ...
        if (file.exists()) {
            ...
            if (!TextUtils.isEmpty(a2)) {
                try {
                    return C0003b.a(new String(com.baidu.android.bbalbs.common.a.a.b(a, a, com.baidu.android.bbalbs.common.a.b.a(a2.getBytes()))));
                } catch (Exception e2) {
                    e2.printStackTrace();
                }
            }
