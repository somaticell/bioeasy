...
class ObjectAnimatorCompatBase {
    ...
    public static ObjectAnimator ofFloat(Object target, String xPropertyName, String yPropertyName, Path path) {
        ...
        return ObjectAnimator.ofPropertyValuesHolder(target, new PropertyValuesHolder[]{PropertyValuesHolder.ofFloat(xPropertyName, xValues), PropertyValuesHolder.ofFloat(yPropertyName, yValues)});
    }
    ...
    public static <T> ObjectAnimator ofFloat(T target, Property<T, Float> xProperty, Property<T, Float> yProperty, Path path) {
        ...
        float[] yValues = new float[NUM_POINTS];
        calculateXYValues(path, xValues, yValues);
        return ObjectAnimator.ofPropertyValuesHolder(target, new PropertyValuesHolder[]{PropertyValuesHolder.ofFloat(xProperty, xValues), PropertyValuesHolder.ofFloat(yProperty, yValues)});
    }
    ...
    public static ObjectAnimator ofInt(Object target, String xPropertyName, String yPropertyName, Path path) {
        ...
        calculateXYValues(path, xValues, yValues);
        return ObjectAnimator.ofPropertyValuesHolder(target, new PropertyValuesHolder[]{PropertyValuesHolder.ofInt(xPropertyName, xValues), PropertyValuesHolder.ofInt(yPropertyName, yValues)});
    }
    ...
    public static <T> ObjectAnimator ofInt(T target, Property<T, Integer> xProperty, Property<T, Integer> yProperty, Path path) {
        ...
        int[] yValues = new int[NUM_POINTS];
        calculateXYValues(path, xValues, yValues);
        return ObjectAnimator.ofPropertyValuesHolder(target, new PropertyValuesHolder[]{PropertyValuesHolder.ofInt(xProperty, xValues), PropertyValuesHolder.ofInt(yProperty, yValues)});
    }
    ...
    private static void calculateXYValues(Path path, @Size(201) float[] xValues, @Size(201) float[] yValues) {
        ...
        for (int i = 0; i < NUM_POINTS; i++) {
            pathMeasure.getPosTan((((float) i) * pathLength) / 200.0f, position, (float[]) null);
