...
public class EditPagePort extends EditPage {
    ...
    public void onCreate() {
        super.onCreate();
        float ratio = ((float) ResHelper.getScreenHeight(this.activity)) / 1280.0f;
        ...
        this.llPage.addView(this.rlTitle, new LinearLayout.LayoutParams(-1, (int) (96.0f * ratio)));
    ...
    private void initBody(RelativeLayout rlBody, float ratio) {
        ...
        llContent.addView(this.etContent, new LinearLayout.LayoutParams(-1, -2));
        ...
        LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(thumbWidth, thumbWidth);
        ...
        this.aivThumb = new AsyncImageView(this.activity) {
            public void onImageGot(String url, Bitmap bm) {
                Bitmap unused = EditPagePort.this.thumb = bm;
