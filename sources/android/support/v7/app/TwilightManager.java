...
class TwilightManager {
    ...
    static TwilightManager getInstance(@NonNull Context context) {
        if (sInstance == null) {
            ...
            sInstance = new TwilightManager(context2, (LocationManager) context2.getSystemService(Headers.LOCATION));
        }
        return sInstance;
    }
    ...
    private void updateState(@NonNull Location location) {
        ...
        calculator.calculateTwilight(now - TimeChart.DAY, location.getLatitude(), location.getLongitude());
        ...
        calculator.calculateTwilight(TimeChart.DAY + now, location.getLatitude(), location.getLongitude());
