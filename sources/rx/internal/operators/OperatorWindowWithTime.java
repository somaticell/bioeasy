...
public final class OperatorWindowWithTime<T> implements Observable.Operator<Observable<T>, T> {
    ...
    final class ExactSubscriber extends Subscriber<T> {
        ...
        public void onCompleted() {
            ...
            L_0x0012:
                java.util.List<java.lang.Object> r2 = r5.queue     // Catch:{ all -> 0x002f }
                rx.internal.operators.NotificationLite<java.lang.Object> r4 = rx.internal.operators.OperatorWindowWithTime.nl     // Catch:{ all -> 0x002f }
            ...
            L_0x0032:
                ...
                goto L_0x001e
            */
            throw new UnsupportedOperationException("Method not decompiled: rx.internal.operators.OperatorWindowWithTime.ExactSubscriber.onCompleted():void");
        }
        ...
        public void nextWindow() {
            ...
            L_0x0012:
                java.util.List<java.lang.Object> r2 = r5.queue     // Catch:{ all -> 0x0033 }
                java.lang.Object r4 = rx.internal.operators.OperatorWindowWithTime.NEXT_SUBJECT     // Catch:{ all -> 0x0033 }
    ...
    final class InexactSubscriber extends Subscriber<T> {
        ...
        public void onNext(T r8) {
            ...
            L_0x0009:
                ...
                java.util.List<rx.internal.operators.OperatorWindowWithTime$CountedSerializedSubject<T>> r4 = r7.chunks     // Catch:{ all -> 0x0032 }
            ...
            L_0x0016:
                ...
                rx.internal.operators.OperatorWindowWithTime$CountedSerializedSubject r0 = (rx.internal.operators.OperatorWindowWithTime.CountedSerializedSubject) r0     // Catch:{ all -> 0x0032 }
                int r4 = r0.count     // Catch:{ all -> 0x0032 }
                int r4 = r4 + 1
                r0.count = r4     // Catch:{ all -> 0x0032 }
                rx.internal.operators.OperatorWindowWithTime r6 = rx.internal.operators.OperatorWindowWithTime.this     // Catch:{ all -> 0x0032 }
            ...
            L_0x003a:
                ...
                rx.internal.operators.OperatorWindowWithTime$CountedSerializedSubject r0 = (rx.internal.operators.OperatorWindowWithTime.CountedSerializedSubject) r0
                rx.Observer<T> r4 = r0.consumer
                r4.onNext(r8)
                int r4 = r0.count
                rx.internal.operators.OperatorWindowWithTime r5 = rx.internal.operators.OperatorWindowWithTime.this
                int r5 = r5.size
        ...
        public void onError(java.lang.Throwable r6) {
            ...
            L_0x0009:
                ...
                java.util.ArrayList r2 = new java.util.ArrayList     // Catch:{ all -> 0x002f }
                java.util.List<rx.internal.operators.OperatorWindowWithTime$CountedSerializedSubject<T>> r3 = r5.chunks     // Catch:{ all -> 0x002f }
            ...
            L_0x002f:
                ...
                throw r3
            L_0x0032:
                rx.Subscriber<? super rx.Observable<T>> r3 = r5.child
                r3.onError(r6)
                goto L_0x0008
            */
        ...
        public void startNewChunk() {
            /*
                r7 = this;
                rx.internal.operators.OperatorWindowWithTime$CountedSerializedSubject r0 = r7.createCountedSerializedSubject()
            ...
            L_0x000c:
                return
            L_0x000d:
                java.util.List<rx.internal.operators.OperatorWindowWithTime$CountedSerializedSubject<T>> r2 = r7.chunks     // Catch:{ all -> 0x002d }
                r2.add(r0)     // Catch:{ all -> 0x002d }
                monitor-exit(r3)     // Catch:{ all -> 0x002d }
                rx.Subscriber<? super rx.Observable<T>> r2 = r7.child     // Catch:{ Throwable -> 0x0030 }
                rx.Observable<T> r3 = r0.producer     // Catch:{ Throwable -> 0x0030 }
                r2.onNext(r3)     // Catch:{ Throwable -> 0x0030 }
                rx.Scheduler$Worker r2 = r7.worker
                rx.internal.operators.OperatorWindowWithTime$InexactSubscriber$2 r3 = new rx.internal.operators.OperatorWindowWithTime$InexactSubscriber$2
                r3.<init>(r0)
                rx.internal.operators.OperatorWindowWithTime r4 = rx.internal.operators.OperatorWindowWithTime.this
                long r4 = r4.timespan
                rx.internal.operators.OperatorWindowWithTime r6 = rx.internal.operators.OperatorWindowWithTime.this
            ...
            L_0x0030:
                ...
                goto L_0x000c
            */
            throw new UnsupportedOperationException("Method not decompiled: rx.internal.operators.OperatorWindowWithTime.InexactSubscriber.startNewChunk():void");
        }
         ...
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public void terminateChunk(rx.internal.operators.OperatorWindowWithTime.CountedSerializedSubject<T> r6) {
            /*
                r5 = this;
                r2 = 0
                java.lang.Object r4 = r5.guard
            ...
            L_0x0009:
                return
            L_0x000a:
                java.util.List<rx.internal.operators.OperatorWindowWithTime$CountedSerializedSubject<T>> r3 = r5.chunks     // Catch:{ all -> 0x002b }
            ...
            L_0x0010:
                ...
                rx.internal.operators.OperatorWindowWithTime$CountedSerializedSubject r0 = (rx.internal.operators.OperatorWindowWithTime.CountedSerializedSubject) r0     // Catch:{ all -> 0x002b }
