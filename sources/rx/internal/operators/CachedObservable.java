...
public final class CachedObservable<T> extends Observable<T> {
    ...
    static final class ReplayProducer<T> extends AtomicLong implements Producer, Subscription {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:110:0x0125, code lost:
            r5.onError(rx.exceptions.OnErrorThrowable.addValueAsLastCause(r6, r10.getValue(r11)));
         */
        ...
        public void replay() {
            ...
            L_0x0013:
                ...
                r15 = 0
                r0 = r20
                rx.internal.operators.CachedObservable$CacheState<T> r0 = r0.state     // Catch:{ all -> 0x01b3 }
                r17 = r0
                r0 = r17
                rx.internal.operators.NotificationLite<T> r10 = r0.nl     // Catch:{ all -> 0x01b3 }
                r0 = r20
                rx.Subscriber<? super T> r5 = r0.child     // Catch:{ all -> 0x01b3 }
            L_0x002b:
            ...
            L_0x0111:
                ...
                r0 = r17
                java.lang.Throwable r17 = rx.exceptions.OnErrorThrowable.addValueAsLastCause(r6, r0)     // Catch:{ all -> 0x01b3 }
                r0 = r17
                r5.onError(r0)     // Catch:{ all -> 0x01b3 }
            L_0x0134:
                if (r15 != 0) goto L_0x0012
