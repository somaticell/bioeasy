...
public final class Type {
    ...
    public static final Type BOOKBOOL = new Type(JfifUtil.MARKER_SOS);
    public static final Type BOOLERR = new Type(UIMsg.m_AppUI.MSG_CITY_SUP_DOM);
    ...
    public static final Type DBCELL = new Type(JfifUtil.MARKER_RST7);
    ...
    public static final Type GRIDSET = new Type(TransportMediator.KEYCODE_MEDIA_RECORD);
    ...
    public static final Type INTERFACEHDR = new Type(JfifUtil.MARKER_APP1);
    public static final Type ITERATION = new Type(17);
    public static final Type LABEL = new Type(UIMsg.m_AppUI.MSG_CHINA_SUP_ITS);
    ...
    public static final Type MMS = new Type(Opcodes.INSTANCEOF);
    ...
    public static final Type ROW = new Type(UIMsg.m_AppUI.MSG_PLACEFIELD_RELOAD);
    ...
    public static final Type SCL = new Type(Opcodes.IF_ICMPNE);
    ...
    public static final Type STRING = new Type(UIMsg.m_AppUI.MSG_SET_SENSOR_STATUS);
    ...
    private static ArbitraryType arbitrary = new ArbitraryType((AnonymousClass1) null);
    private static Type[] types = new Type[0];
    public final int value;

    /* renamed from: jxl.biff.Type$1  reason: invalid class name */
    ...
    private static class ArbitraryType {
        ...
        ArbitraryType(AnonymousClass1 x0) {
            this();
        }
    }
