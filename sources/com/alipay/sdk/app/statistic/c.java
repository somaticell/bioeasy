...
public final class c {
    ...
    String I = String.format("123456789,%s", new Object[]{new SimpleDateFormat("yyyy-MM-dd-HH:mm:ss").format(new Date())});
    String J;
    String K;
    String L;
    String M;
    ...
    public c(Context context) {
        ...
        this.M = String.format("%s,%s,-,-,-", new Object[]{a(b.a().a), a(com.alipay.sdk.sys.b.a().c())});
        this.N = String.format("%s,%s,%s,%s,%s,%s,%s,%s,%s,-", new Object[]{a(com.alipay.sdk.util.a.d(context)), "android", a(Build.VERSION.RELEASE), a(Build.MODEL), "-", a(com.alipay.sdk.util.a.a(context).a()), a(com.alipay.sdk.util.a.b(context).p), "gw", a(com.alipay.sdk.util.a.a(context).b())});
        this.O = "-";
        this.P = "-";
        this.R = "-";
    }
    ...
    static String a(String str) {
        ...
        return str.replace("[", "【").replace("]", "】").replace("(", "（").replace(")", "）").replace(ListUtils.DEFAULT_JOIN_SEPARATOR, "，").replace("-", "=").replace("^", "~");
    }
    ...
    private static String d() {
        return String.format("%s,%s,-,-,-", new Object[]{a(b.a().a), a(com.alipay.sdk.sys.b.a().c())});
    }

    private static String b(Context context) {
        return String.format("%s,%s,%s,%s,%s,%s,%s,%s,%s,-", new Object[]{a(com.alipay.sdk.util.a.d(context)), "android", a(Build.VERSION.RELEASE), a(Build.MODEL), "-", a(com.alipay.sdk.util.a.a(context).a()), a(com.alipay.sdk.util.a.b(context).p), "gw", a(com.alipay.sdk.util.a.a(context).b())});
    }
}
