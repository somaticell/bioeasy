...
public class a {
    ...
    private static void c(Context context, int i2) {
        ...
        if (!TextUtils.isEmpty(m) && k != null) {
            sb.append("name:").append(m).append("|latlng:").append(k.latitude).append(ListUtils.DEFAULT_JOIN_SEPARATOR).append(k.longitude);
        } else if (!TextUtils.isEmpty(m)) {
            sb.append(m);
        } else if (k != null) {
            sb.append(k.latitude).append(ListUtils.DEFAULT_JOIN_SEPARATOR).append(k.longitude);
        }
        ...
        if (!TextUtils.isEmpty(n) && l != null) {
            sb.append("name:").append(n).append("|latlng:").append(l.latitude).append(ListUtils.DEFAULT_JOIN_SEPARATOR).append(l.longitude);
        } else if (!TextUtils.isEmpty(n)) {
            sb.append(n);
        } else if (l != null) {
            sb.append(l.latitude).append(ListUtils.DEFAULT_JOIN_SEPARATOR).append(l.longitude);
        }
        sb.append("&mode=").append(strArr[i2]);
        sb.append("&target=").append(com.alipay.sdk.cons.a.e);
        sb.append("&src=").append("sdk_[" + g + "]");
        Intent intent = new Intent("android.intent.action.VIEW", Uri.parse(sb.toString()));
        intent.setFlags(268435456);
        context.startActivity(intent);
    ...
    private static void d(Context context) {
        ...
        sb.append("center=").append(r.latitude).append(ListUtils.DEFAULT_JOIN_SEPARATOR).append(r.longitude);
    ...
    private static void e(Context context) {
        ...
        sb.append("origin=").append(k.latitude).append(ListUtils.DEFAULT_JOIN_SEPARATOR).append(k.longitude);
        sb.append("&location=").append(l.latitude).append(ListUtils.DEFAULT_JOIN_SEPARATOR).append(l.longitude);
        sb.append("&src=").append("sdk_[" + g + "]");
        Intent intent = new Intent("android.intent.action.VIEW", Uri.parse(sb.toString()));
        intent.setFlags(268435456);
        context.startActivity(intent);
    ...
    private static void f(Context context) {
        ...
        sb.append("origin=").append(k.latitude).append(ListUtils.DEFAULT_JOIN_SEPARATOR).append(k.longitude);
        sb.append("&destination=").append(l.latitude).append(ListUtils.DEFAULT_JOIN_SEPARATOR).append(l.longitude);
        sb.append("&src=").append("sdk_[" + g + "]");
        Intent intent = new Intent("android.intent.action.VIEW", Uri.parse(sb.toString()));
        intent.setFlags(268435456);
        context.startActivity(intent);
    ...
    private static boolean i() {
        ...
        try {
            ...
            Log.d(c, "callDispatchPoiToBaiduMap exception", e5);
        }
    }
