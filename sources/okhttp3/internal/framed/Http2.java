...
public final class Http2 implements Variant {
    ...
    static final class Reader implements FrameReader {
        ...
        public boolean nextFrame(FrameReader.Handler handler) throws IOException {
            try {
                ...
                byte type = (byte) (this.source.readByte() & BLEServiceApi.CONNECTED_STATUS);
                byte flags = (byte) (this.source.readByte() & BLEServiceApi.CONNECTED_STATUS);
        ...
        private void readHeaders(FrameReader.Handler handler, int length, byte flags, int streamId) throws IOException {
            ...
            if ((flags & 8) != 0) {
                padding = (short) (this.source.readByte() & BLEServiceApi.CONNECTED_STATUS);
            } else {
                padding = 0;
            }
            if ((flags & 32) != 0) {
        ...
        private void readPriority(FrameReader.Handler handler, int streamId) throws IOException {
            ...
            handler.priority(streamId, w1 & ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, (this.source.readByte() & BLEServiceApi.CONNECTED_STATUS) + 1, (Integer.MIN_VALUE & w1) != 0);
        }
        ...
        private void readPushPromise(FrameReader.Handler handler, int length, byte flags, int streamId) throws IOException {
            ...
            handler.pushPromise(streamId, this.source.readInt() & ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, readHeaderBlock(Http2.lengthWithoutPadding(length - 4, flags, padding), padding, flags, streamId));
        }
    ...
    static final class Writer implements FrameWriter {
        ...
        public void frameHeader(int streamId, int length, byte type, byte flags) throws IOException {
            ...
            if (length > this.maxFrameSize) {
                ...
                this.sink.writeByte(type & BLEServiceApi.CONNECTED_STATUS);
                this.sink.writeByte(flags & BLEServiceApi.CONNECTED_STATUS);
    ...
    static final class ContinuationSource implements Source {
        ...
        private void readContinuationHeader() throws IOException {
            ...
            byte type = (byte) (this.source.readByte() & BLEServiceApi.CONNECTED_STATUS);
            this.flags = (byte) (this.source.readByte() & BLEServiceApi.CONNECTED_STATUS);
            if (Http2.logger.isLoggable(Level.FINE)) {
    ...
    public static int readMedium(BufferedSource source) throws IOException {
        return ((source.readByte() & BLEServiceApi.CONNECTED_STATUS) << 16) | ((source.readByte() & BLEServiceApi.CONNECTED_STATUS) << 8) | (source.readByte() & BLEServiceApi.CONNECTED_STATUS);
    }
