...
public class f implements Thread.UncaughtExceptionHandler {
    ...
    private boolean a(String str, String str2) {
        ...
        try {
            ...
            httpURLConnection.setConnectTimeout(com.baidu.location.f.a.b);
            httpURLConnection.setReadTimeout(com.baidu.location.f.a.b);
    ...
    public void uncaughtException(java.lang.Thread r10, java.lang.Throwable r11) {
        ...
        L_0x0015:
            ...
            long r6 = com.baidu.location.e.a.a()
            long r2 = r2 - r6
            r6 = 10000(0x2710, double:4.9407E-320)
            int r0 = (r2 > r6 ? 1 : (r2 == r6 ? 0 : -1))
            if (r0 >= 0) goto L_0x0071
            r0 = 1089533379(0x40f0f5c3, float:7.53)
            float r2 = com.baidu.location.f.getFrameVersion()
            int r0 = (r0 > r2 ? 1 : (r0 == r2 ? 0 : -1))
            if (r0 <= 0) goto L_0x0071
            com.baidu.location.f.c r0 = com.baidu.location.f.c.a()
            long r2 = r0.c()
            ...
            r2.<init>()
            java.lang.String r3 = com.baidu.location.f.j.h()
            java.lang.StringBuilder r2 = r2.append(r3)
            java.lang.String r3 = java.io.File.separator
            java.lang.StringBuilder r2 = r2.append(r3)
            java.lang.String r3 = com.baidu.location.f.getJarFileName()
            java.lang.StringBuilder r2 = r2.append(r3)
        ...
        L_0x0071:
            ...
            r3 = 1
        L_0x0080:
            com.baidu.location.f.b r0 = com.baidu.location.f.b.a()     // Catch:{ Exception -> 0x013f }
            r5 = 0
            java.lang.String r0 = r0.a((boolean) r5)     // Catch:{ Exception -> 0x013f }
            ...
            java.lang.String r5 = r5.f()     // Catch:{ Exception -> 0x013f }
            java.lang.StringBuilder r0 = r0.append(r5)     // Catch:{ Exception -> 0x013f }
            java.lang.String r0 = r0.toString()     // Catch:{ Exception -> 0x013f }
            if (r0 == 0) goto L_0x0144
            java.lang.String r0 = com.baidu.location.Jni.encode(r0)     // Catch:{ Exception -> 0x013f }
        L_0x00a8:
            r8 = r3
            r3 = r0
            r0 = r8
