...
public class g {
    ...
    private boolean a(Location location, int i2, int i3) {
        ...
        long j2 = time - h;
        if (fArr[0] < ((float) j.ab) && j2 < ((long) j.ac)) {
            return false;
        }
        if (d == null) {
            f++;
    ...
    private boolean a(String str) {
        ...
        try {
            ...
            if (readInt == 0) {
                ...
                int i2 = readInt3 == j.ad ? 1 : readInt3 + 1;
                int i3 = i2 == j.ad ? 1 : i2 + 1;
                randomAccessFile.seek(4);
                randomAccessFile.writeInt(i3);
                randomAccessFile.writeInt(i2);
            } else {
                int i4 = readInt3 == j.ad ? 1 : readInt3 + 1;
                if (i4 == readInt2) {
                    int i5 = i4 == j.ad ? 1 : i4 + 1;
                    randomAccessFile.seek(4);
    ...
    public static String b() {
        ...
        try {
            ...
            if (!a(readInt, readInt2, readInt3)) {
                ...
                int i3 = readInt < j.ad ? readInt2 + 1 : readInt2 == j.ad ? 1 : readInt2 + 1;
                randomAccessFile.seek(4);
                randomAccessFile.writeInt(i3);
                randomAccessFile.close();
                return str;
