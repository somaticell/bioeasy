...
public final class UnicastSubject<T> extends Subject<T, T> {
    ...
    public static <T> UnicastSubject<T> create(int capacityHint) {
        return new UnicastSubject<>(new State<>(capacityHint, (Action0) null));
    }
    ...
    static final class State<T> extends AtomicLong implements Producer, Observer<T>, Action0, Observable.OnSubscribe<T> {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:14:0x0032, code lost:
            if (r6 != com.facebook.common.time.Clock.MAX_TIME) goto L_0x0075;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:54:0x008a, code lost:
            ...
            r8.onError(rx.exceptions.OnErrorThrowable.addValueAsLastCause(r4, r11));
         */
        ...
        public void doTerminate() {
            ...
            if (ref != null && (a = ref.get()) != null && ref.compareAndSet(a, (Object) null)) {
                a.call();
            }
        }
    }
