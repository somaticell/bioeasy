...
public final class OnSubscribePublishMulticast<T> extends AtomicInteger implements Observable.OnSubscribe<T>, Observer<T>, Subscription {
    ...
    public void remove(rx.internal.operators.OnSubscribePublishMulticast.PublishProducer<T> r8) {
        /*
            r7 = this;
            rx.internal.operators.OnSubscribePublishMulticast$PublishProducer<T>[] r0 = r7.subscribers
            rx.internal.operators.OnSubscribePublishMulticast$PublishProducer<?>[] r5 = TERMINATED
            if (r0 == r5) goto L_0x000a
            rx.internal.operators.OnSubscribePublishMulticast$PublishProducer<?>[] r5 = EMPTY
        ...
        L_0x000b:
            ...
            rx.internal.operators.OnSubscribePublishMulticast$PublishProducer<?>[] r5 = TERMINATED     // Catch:{ all -> 0x0018 }
            if (r0 == r5) goto L_0x0016
            rx.internal.operators.OnSubscribePublishMulticast$PublishProducer<?>[] r5 = EMPTY     // Catch:{ all -> 0x0018 }
        ...
        L_0x002c:
            ...
            rx.internal.operators.OnSubscribePublishMulticast$PublishProducer<?>[] r1 = EMPTY     // Catch:{ all -> 0x0018 }
