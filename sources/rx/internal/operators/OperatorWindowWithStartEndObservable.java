    ...
    final class SourceSubscriber extends Subscriber<T> {
        ...
        public void onNext(T r6) {
            ...
            L_0x0009:
                ...
                java.util.List<rx.internal.operators.OperatorWindowWithStartEndObservable$SerializedSubject<T>> r3 = r5.chunks     // Catch:{ all -> 0x0027 }
            ...
            L_0x0015:
                ...
                rx.internal.operators.OperatorWindowWithStartEndObservable$SerializedSubject r0 = (rx.internal.operators.OperatorWindowWithStartEndObservable.SerializedSubject) r0
        ...
        public void onError(java.lang.Throwable r6) {
            /*
                ...
                rx.subscriptions.CompositeSubscription r3 = r5.csub
                r3.unsubscribe()
            L_0x000d:
                return
            L_0x000e:
                ...
                java.util.List<rx.internal.operators.OperatorWindowWithStartEndObservable$SerializedSubject<T>> r3 = r5.chunks     // Catch:{ all -> 0x003b }
            ...
            L_0x0022:
                ...
                rx.internal.operators.OperatorWindowWithStartEndObservable$SerializedSubject r0 = (rx.internal.operators.OperatorWindowWithStartEndObservable.SerializedSubject) r0     // Catch:{ all -> 0x0034 }
                rx.Observer<T> r3 = r0.consumer     // Catch:{ all -> 0x0034 }
                r3.onError(r6)     // Catch:{ all -> 0x0034 }
                goto L_0x0022
            L_0x0034:
                r3 = move-exception
                rx.subscriptions.CompositeSubscription r4 = r5.csub
                r4.unsubscribe()
                throw r3
            L_0x003b:
                r3 = move-exception
            ...
            L_0x003e:
                rx.Subscriber<? super rx.Observable<T>> r3 = r5.child     // Catch:{ all -> 0x0034 }
                r3.onError(r6)     // Catch:{ all -> 0x0034 }
                rx.subscriptions.CompositeSubscription r3 = r5.csub
                r3.unsubscribe()
                goto L_0x000d
        ...
        public void beginWindow(U r7) {
            /*
                r6 = this;
                rx.internal.operators.OperatorWindowWithStartEndObservable$SerializedSubject r2 = r6.createSerializedSubject()
            ...
            L_0x000c:
                return
            L_0x000d:
                java.util.List<rx.internal.operators.OperatorWindowWithStartEndObservable$SerializedSubject<T>> r4 = r6.chunks     // Catch:{ all -> 0x0032 }
                r4.add(r2)     // Catch:{ all -> 0x0032 }
                monitor-exit(r5)     // Catch:{ all -> 0x0032 }
                rx.Subscriber<? super rx.Observable<T>> r4 = r6.child
                rx.Observable<T> r5 = r2.producer
                r4.onNext(r5)
                rx.internal.operators.OperatorWindowWithStartEndObservable r4 = rx.internal.operators.OperatorWindowWithStartEndObservable.this     // Catch:{ Throwable -> 0x0035 }
                rx.functions.Func1<? super U, ? extends rx.Observable<? extends V>> r4 = r4.windowClosingSelector     // Catch:{ Throwable -> 0x0035 }
                java.lang.Object r1 = r4.call(r7)     // Catch:{ Throwable -> 0x0035 }
                rx.Observable r1 = (rx.Observable) r1     // Catch:{ Throwable -> 0x0035 }
                rx.internal.operators.OperatorWindowWithStartEndObservable$SourceSubscriber$1 r3 = new rx.internal.operators.OperatorWindowWithStartEndObservable$SourceSubscriber$1
                r3.<init>(r2)
                rx.subscriptions.CompositeSubscription r4 = r6.csub
                r4.add(r3)
            ...
            L_0x0035:
                ...
                goto L_0x000c
            */
            throw new UnsupportedOperationException("Method not decompiled: rx.internal.operators.OperatorWindowWithStartEndObservable.SourceSubscriber.beginWindow(java.lang.Object):void");
        }
         ...
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public void endWindow(rx.internal.operators.OperatorWindowWithStartEndObservable.SerializedSubject<T> r6) {
            /*
                r5 = this;
                r2 = 0
                java.lang.Object r4 = r5.guard
            ...
            L_0x0009:
                return
            L_0x000a:
                java.util.List<rx.internal.operators.OperatorWindowWithStartEndObservable$SerializedSubject<T>> r3 = r5.chunks     // Catch:{ all -> 0x002b }
            ...
            L_0x0010:
                ...
                rx.internal.operators.OperatorWindowWithStartEndObservable$SerializedSubject r1 = (rx.internal.operators.OperatorWindowWithStartEndObservable.SerializedSubject) r1     // Catch:{ all -> 0x002b }
