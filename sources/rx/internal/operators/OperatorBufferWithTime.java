    ...
    final class InexactSubscriber extends Subscriber<T> {
        ...
        public void onNext(T r8) {
            ...
            L_0x000f:
                ...
                rx.internal.operators.OperatorBufferWithTime r6 = rx.internal.operators.OperatorBufferWithTime.this     // Catch:{ all -> 0x0055 }
            ...
            L_0x003e:
                ...
                rx.Subscriber<? super java.util.List<T>> r5 = r7.child
                r5.onNext(r0)
                goto L_0x003e
            L_0x0050:
                r5 = move-exception
        ...
        public void onCompleted() {
            ...
            L_0x002d:
                ...
                rx.exceptions.Exceptions.throwOrReport((java.lang.Throwable) r3, (rx.Observer<?>) r4)
                goto L_0x0006
            L_0x0034:
                r4 = move-exception
                monitor-exit(r5)     // Catch:{ all -> 0x0034 }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:17:0x002a, code lost:
            rx.exceptions.Exceptions.throwOrReport(r3, (rx.Observer<?>) r5);
         */
        ...
        public void emitChunk(java.util.List<T> r6) {
            ...
            L_0x0020:
                ...
                rx.Subscriber<? super java.util.List<T>> r4 = r5.child     // Catch:{ Throwable -> 0x0029 }
    ...
    final class ExactSubscriber extends Subscriber<T> {
        ...
        public void emit() {
            ...
            L_0x0007:
                ...
                monitor-exit(r3)     // Catch:{ all -> 0x001c }
                rx.Subscriber<? super java.util.List<T>> r2 = r3.child     // Catch:{ Throwable -> 0x0017 }
                r2.onNext(r1)     // Catch:{ Throwable -> 0x0017 }
                goto L_0x0006
            L_0x0017:
                r0 = move-exception
                rx.exceptions.Exceptions.throwOrReport((java.lang.Throwable) r0, (rx.Observer<?>) r3)
                goto L_0x0006
            L_0x001c:
                r2 = move-exception
                monitor-exit(r3)     // Catch:{ all -> 0x001c }
                throw r2
            */
            throw new UnsupportedOperationException("Method not decompiled: rx.internal.operators.OperatorBufferWithTime.ExactSubscriber.emit():void");
        }
    }
}
