...
public class Axis {
    ...
    private String name;
    private int textColor = DefaultRenderer.TEXT_COLOR;
    ...
    public static Axis generateAxisFromCollection(List<Float> axisValues) {
        ...
        for (Float floatValue : axisValues) {
            values2.add(new AxisValue(floatValue.floatValue()));
            index++;
        }
        return new Axis(values2);
    }
    ...
    public static Axis generateAxisFromCollection(List<Float> axisValues, List<String> axisValuesLabels) {
        ...
        int index = 0;
        for (Float floatValue : axisValues) {
            values2.add(new AxisValue(floatValue.floatValue()).setLabel(axisValuesLabels.get(index)));
            index++;
        }
        return new Axis(values2);
    }
