...
public class SwitchButton extends CompoundButton {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs == null) {
            ...
            ta = getContext().obtainStyledAttributes(attrs, R.styleable.SwitchButton);
        }
        if (ta != null) {
            ...
            float margin2 = ta.getDimension(R.styleable.SwitchButton_kswThumbMargin, margin);
            marginLeft = ta.getDimension(R.styleable.SwitchButton_kswThumbMarginLeft, margin2);
            marginRight = ta.getDimension(R.styleable.SwitchButton_kswThumbMarginRight, margin2);
            marginTop = ta.getDimension(R.styleable.SwitchButton_kswThumbMarginTop, margin2);
            marginBottom = ta.getDimension(R.styleable.SwitchButton_kswThumbMarginBottom, margin2);
            ...
            backRadius = ta.getDimension(R.styleable.SwitchButton_kswBackRadius, (2.0f * density) + thumbRadius);
            ...
            backMeasureRatio = ta.getFloat(R.styleable.SwitchButton_kswBackMeasureRatio, 1.8f);
            animationDuration = ta.getInteger(R.styleable.SwitchButton_kswAnimationDuration, 250);
            fadeBack = ta.getBoolean(R.styleable.SwitchButton_kswFadeBack, true);
            tintColor = ta.getColor(R.styleable.SwitchButton_kswTintColor, 0);
            textOn = ta.getString(R.styleable.SwitchButton_kswTextOn);
            textOff = ta.getString(R.styleable.SwitchButton_kswTextOff);
            textMarginH = ta.getDimension(R.styleable.SwitchButton_kswTextMarginH, Math.max(textMarginH, backRadius / 2.0f));
            autoAdjustTextPosition = ta.getBoolean(R.styleable.SwitchButton_kswAutoAdjustTextPosition, true);
            ta.recycle();
        }
        if (attrs == null) {
            ta2 = null;
        } else {
            ta2 = getContext().obtainStyledAttributes(attrs, new int[]{16842970, 16842981});
        }
        if (ta2 != null) {
    ...
    private int measureWidth(int widthMeasureSpec) {
        ...
        int minWidth2 = Math.max(minWidth, ceil((double) (((float) minWidth) + this.mThumbMargin.left + this.mThumbMargin.right)));
