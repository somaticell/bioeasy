...
final class Hpack {
    ...
    /* access modifiers changed from: private */
    public static final Header[] STATIC_HEADER_TABLE = {new Header(Header.TARGET_AUTHORITY, ""), new Header(Header.TARGET_METHOD, "GET"), new Header(Header.TARGET_METHOD, "POST"), new Header(Header.TARGET_PATH, "/"), new Header(Header.TARGET_PATH, "/index.html"), new Header(Header.TARGET_SCHEME, (String) UriUtil.HTTP_SCHEME), new Header(Header.TARGET_SCHEME, "https"), new Header(Header.RESPONSE_STATUS, "200"), new Header(Header.RESPONSE_STATUS, "204"), new Header(Header.RESPONSE_STATUS, "206"), new Header(Header.RESPONSE_STATUS, "304"), new Header(Header.RESPONSE_STATUS, "400"), new Header(Header.RESPONSE_STATUS, "404"), new Header(Header.RESPONSE_STATUS, "500"), new Header("accept-charset", ""), new Header("accept-encoding", "gzip, deflate"), new Header("accept-language", ""), new Header((String) Headers.ACCEPT_RANGES, ""), new Header("accept", ""), new Header("access-control-allow-origin", ""), new Header("age", ""), new Header("allow", ""), new Header("authorization", ""), new Header((String) Headers.CACHE_CONTROL, ""), new Header((String) Headers.CONTENT_DISPOSITION, ""), new Header((String) Headers.CONTENT_ENCODING, ""), new Header("content-language", ""), new Header((String) Headers.CONTENT_LEN, ""), new Header("content-location", ""), new Header("content-range", ""), new Header("content-type", ""), new Header("cookie", ""), new Header("date", ""), new Header((String) Headers.ETAG, ""), new Header("expect", ""), new Header((String) Headers.EXPIRES, ""), new Header("from", ""), new Header((String) c.f, ""), new Header("if-match", ""), new Header("if-modified-since", ""), new Header("if-none-match", ""), new Header("if-range", ""), new Header("if-unmodified-since", ""), new Header((String) Headers.LAST_MODIFIED, ""), new Header("link", ""), new Header((String) Headers.LOCATION, ""), new Header("max-forwards", ""), new Header((String) Headers.PROXY_AUTHENTICATE, ""), new Header("proxy-authorization", ""), new Header("range", ""), new Header("referer", ""), new Header((String) Headers.REFRESH, ""), new Header("retry-after", ""), new Header("server", ""), new Header((String) Headers.SET_COOKIE, ""), new Header("strict-transport-security", ""), new Header((String) Headers.TRANSFER_ENCODING, ""), new Header("user-agent", ""), new Header("vary", ""), new Header("via", ""), new Header((String) Headers.WWW_AUTHENTICATE, "")};
    ...
    static final class Reader {
        ...
        private int readByte() throws IOException {
            return this.source.readByte() & BLEServiceApi.CONNECTED_STATUS;
        }
