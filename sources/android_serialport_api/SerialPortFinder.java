...
public class SerialPortFinder {
    ...
    public String[] getAllDevices() {
        ...
        try {
            ...
            while (itdriv.hasNext()) {
                ...
                while (itdev.hasNext()) {
                    devices.add(String.format("%s (%s)", new Object[]{itdev.next().getName(), driver.getName()}));
                }
            }
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public String[] getAllDevicesPath() {
        ...
        try {
            Iterator<Driver> itdriv = getDrivers().iterator();
            while (itdriv.hasNext()) {
                Iterator<File> itdev = itdriv.next().getDevices().iterator();
                while (itdev.hasNext()) {
                    devices.add(itdev.next().getAbsolutePath());
                }
            }
        } catch (IOException e) {
            e.printStackTrace();
