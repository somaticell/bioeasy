...
public class ASMDeserializerFactory implements Opcodes {
    ...
    private void _deserialze(ClassWriter cw, Context context) {
        if (context.fieldInfoList.length != 0) {
            ...
            methodWriter.visitJumpInsn(Opcodes.IFEQ, super_);
            methodWriter.visitVarInsn(25, context.var("lexer"));
            ...
            methodWriter.visitJumpInsn(Opcodes.IF_ICMPEQ, super_);
            methodWriter.visitVarInsn(25, 1);
            ...
            methodWriter.visitJumpInsn(Opcodes.IF_ICMPEQ, return_);
            methodWriter.visitInsn(3);
            ...
            for (int i4 = 0; i4 < fieldListSize; i4++) {
                ...
                if (fieldClass3 == Boolean.TYPE) {
                    ...
                    methodWriter.visitVarInsn(25, 1);
                    methodWriter.visitMethodInsn(Opcodes.INVOKEVIRTUAL, DefaultJSONParser, "getSymbolTable", "()" + ASMUtils.desc((Class<?>) SymbolTable.class));
                    methodWriter.visitMethodInsn(Opcodes.INVOKEVIRTUAL, JSONLexerBase, "scanFieldSymbol", "([C" + ASMUtils.desc((Class<?>) SymbolTable.class) + ")Ljava/lang/String;");
                    methodWriter.visitInsn(89);
                    methodWriter.visitVarInsn(58, context.var(fieldInfo3.name + "_asm_enumName"));
                    methodWriter.visitJumpInsn(Opcodes.IFNULL, enumNull_);
                    methodWriter.visitVarInsn(25, context.var(fieldInfo3.name + "_asm_enumName"));
                    methodWriter.visitMethodInsn(Opcodes.INVOKEVIRTUAL, ASMUtils.type(String.class), "length", "()I");
                    methodWriter.visitJumpInsn(Opcodes.IFEQ, enumNull_);
                    methodWriter.visitVarInsn(25, context.var(fieldInfo3.name + "_asm_enumName"));
                    methodWriter.visitMethodInsn(Opcodes.INVOKESTATIC, ASMUtils.type(fieldClass3), "valueOf", "(Ljava/lang/String;)" + ASMUtils.desc(fieldClass3));
                    methodWriter.visitVarInsn(58, context.var(fieldInfo3.name + "_asm"));
                    methodWriter.visitLabel(enumNull_);
                } else {
                ...
                methodWriter.visitLdcInsn(-1);
                methodWriter.visitJumpInsn(Opcodes.IF_ICMPEQ, reset_);
                methodWriter.visitVarInsn(25, context.var("lexer"));
                methodWriter.visitFieldInsn(Opcodes.GETFIELD, JSONLexerBase, "matchStat", "I");
                methodWriter.visitJumpInsn(Opcodes.IFLE, notMatch_);
                ...
                methodWriter.visitFieldInsn(Opcodes.GETFIELD, JSONLexerBase, "matchStat", "I");
                methodWriter.visitLdcInsn(4);
                methodWriter.visitJumpInsn(Opcodes.IF_ICMPEQ, end_);
                methodWriter.visitLabel(notMatch_);
                if (i4 == fieldListSize - 1) {
                    methodWriter.visitVarInsn(25, context.var("lexer"));
                    methodWriter.visitFieldInsn(Opcodes.GETFIELD, JSONLexerBase, "matchStat", "I");
                    methodWriter.visitLdcInsn(4);
                    methodWriter.visitJumpInsn(Opcodes.IF_ICMPNE, reset_);
                }
            }
            ...
            methodWriter.visitVarInsn(25, context.var("instance"));
            methodWriter.visitVarInsn(21, 4);
            methodWriter.visitMethodInsn(Opcodes.INVOKEVIRTUAL, ASMUtils.type(JavaBeanDeserializer.class), "parseRest", "(L" + DefaultJSONParser + ";Ljava/lang/reflect/Type;Ljava/lang/Object;Ljava/lang/Object;I)Ljava/lang/Object;");
    ...
    private void _getFieldDeser(Context context, MethodVisitor mw, FieldInfo fieldInfo) {
        Label notNull_ = new Label();
        mw.visitVarInsn(25, 0);
        mw.visitFieldInsn(Opcodes.GETFIELD, context.className, fieldInfo.name + "_asm_deser__", ASMUtils.desc((Class<?>) ObjectDeserializer.class));
        mw.visitJumpInsn(Opcodes.IFNONNULL, notNull_);
        mw.visitVarInsn(25, 0);
        mw.visitVarInsn(25, 1);
        mw.visitMethodInsn(Opcodes.INVOKEVIRTUAL, DefaultJSONParser, "getConfig", "()" + ASMUtils.desc((Class<?>) ParserConfig.class));
        mw.visitLdcInsn(com.alibaba.fastjson.asm.Type.getType(ASMUtils.desc(fieldInfo.fieldClass)));
        mw.visitMethodInsn(Opcodes.INVOKEVIRTUAL, ASMUtils.type(ParserConfig.class), "getDeserializer", "(Ljava/lang/reflect/Type;)" + ASMUtils.desc((Class<?>) ObjectDeserializer.class));
        mw.visitFieldInsn(Opcodes.PUTFIELD, context.className, fieldInfo.name + "_asm_deser__", ASMUtils.desc((Class<?>) ObjectDeserializer.class));
        mw.visitLabel(notNull_);
        mw.visitVarInsn(25, 0);
        mw.visitFieldInsn(Opcodes.GETFIELD, context.className, fieldInfo.name + "_asm_deser__", ASMUtils.desc((Class<?>) ObjectDeserializer.class));
    }
    ...
    private void _init(ClassWriter cw, Context context) {
        ...
        for (FieldInfo fieldInfo2 : context.fieldInfoList) {
            ...
            mw.visitFieldInsn(Opcodes.PUTFIELD, context.className, fieldInfo2.name + "_asm_prefix__", "[C");
        }
