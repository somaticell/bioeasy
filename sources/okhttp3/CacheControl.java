...
public final class CacheControl {
        ...
        for (int i = 0; i < size; i++) {
            ...
            while (pos < value.length()) {
                ...
                if ("no-cache".equalsIgnoreCase(directive)) {
                    ...
                    maxStaleSeconds2 = HeaderParser.parseSeconds(parameter, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
    ...
    public static final class Builder {
        ...
        public Builder maxAge(int maxAge, TimeUnit timeUnit) {
            ...
            this.maxAgeSeconds = maxAgeSecondsLong > 2147483647L ? ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED : (int) maxAgeSecondsLong;
            return this;
        }
        ...
        public Builder maxStale(int maxStale, TimeUnit timeUnit) {
            ...
            this.maxStaleSeconds = maxStaleSecondsLong > 2147483647L ? ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED : (int) maxStaleSecondsLong;
            return this;
        }
        ...
        public Builder minFresh(int minFresh, TimeUnit timeUnit) {
            ...
            this.minFreshSeconds = minFreshSecondsLong > 2147483647L ? ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED : (int) minFreshSecondsLong;
            return this;
        }
