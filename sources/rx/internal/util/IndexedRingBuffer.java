...
public final class IndexedRingBuffer<E> implements Subscription {
    ...
    public void releaseToPool() {
        ...
        while (true) {
            ...
            while (i < SIZE) {
                ...
                section.array.set(i, (Object) null);
                i++;
                realIndex++;
            }
    ...
    public E remove(int index2) {
        E e;
        if (index2 < SIZE) {
            e = this.elements.array.getAndSet(index2, (Object) null);
        } else {
            e = getElementSection(index2).array.getAndSet(index2 % SIZE, (Object) null);
        }
    ...
    private static class ElementSection<E> {
        ...
        public ElementSection<E> getNext() {
            ...
            if (this.next.compareAndSet((Object) null, newSection)) {
                return newSection;
            }
            return this.next.get();
        }
    ...
    private static class IndexSection {
        ...
        public IndexSection getNext() {
            ...
            if (this._next.compareAndSet((Object) null, newSection)) {
                return newSection;
            }
            return this._next.get();
        }
